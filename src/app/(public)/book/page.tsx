...
import { Clock, Shield, Phone, ChevronRight, CalendarCheck } from "lucide-react";

const infoItems = [
  {
    icon: Clock,
    label: "Availability",
    value: "Mon — Fri, 9:00 AM – 5:00 PM (UK)",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold heading-tight mb-6 text-white leading-[1.1]">
              Book a{" "}
              <span className="text-corp-blue-light">Consultation</span>
            </h1>
            <p className="text-lg text-white/70 leading-relaxed max-w-2xl">
              Choose a service, select a time, and we&apos;ll confirm your
              appointment&mdash;no obligation, no commitment.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <p className="text-sm text-text-secondary leading-relaxed mb-8">
                Select a service type, choose your preferred date and time, and
                provide your details. We&apos;ll confirm your booking promptly.
              </p>
